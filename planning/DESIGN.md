...
- **Google/Antigravity** (Gemini models via Vertex AI/AI Studio)
- **LLMStudio** (Local models via LLMStudio / OpenAI-compatible API)
...
format_tools_for_provider(provider) -> ProviderToolFormat
  ...
  - Antigravity uses specific JSON schema
  - LLMStudio and OpenRouter may use different format
```
