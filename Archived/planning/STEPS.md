# Detective Agent Implementation Steps
...
- Provider implementation (Anthropic, OpenRouter, OpenAI, LLMStudio, etc)
...
### Step 4: Observability (Traces and Spans)
...
### Step 7: Evaluation System (Optional)
