...
- **Step 6**: Evaluations
- **Step 7 (Optional)**: Add an MCP tool
...
**Goal:** Extend the agent with Model Context Protocol integration

**What You'll Build:**
- Integration with an MCP server
- Custom MCP tool for additional functionality

**Success Criteria:**
- MCP tool successfully integrated
- Agent can call MCP tool alongside existing tools
...
**After Step 7:** You have extended capabilities via MCP ✅
