...
class TestConversationPersistence:
    ...
    def test_initialization(self, temp_conversations_dir, mock_config):
        ...
        assert "+00:00" in persistence.started_at or persistence.started_at.endswith("Z")
    ...
    def test_save_with_tool_calls(self, temp_conversations_dir, mock_config):
        ...
        assert data["messages"][3]["content"] == "Here are the available features: FEAT-001"
    ...
    def test_get_filepath(self, temp_conversations_dir, mock_config):
        ...
        assert filepath == temp_conversations_dir / f"{persistence.conversation_id}.json"
